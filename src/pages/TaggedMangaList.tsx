...
const TaggedMangaList: React.FC = () => {
  ...
  const filteredManga = mockManga.filter(manga => manga.genres.includes(tag || ''))

  return (
    <div>
      <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Manga with {tag} Tag</h1>
...
export default TaggedMangaList